...
import com.example.myapplication.Sellers.ui.dashboard.DashboardFragment;
import com.example.myapplication.Sellers.ui.notifications.NotificationsFragment;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Products, ItemViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ItemViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(ItemViewHolder holder, int i, final Products model) {

                        holder.txtProductName.setText(model.getPname());
                        holder.txtProductDescription.setText(model.getDescription());
                        holder.txtProductPrice.setText("Price = " + model.getPrice() + "$");
                        holder.txtProductStatus.setText ("Product State: " + model.getProductState());
